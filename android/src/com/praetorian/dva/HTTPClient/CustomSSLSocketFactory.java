...
/**
 * Custom SSL Connection which will make it easy to connect to our development
 * servers. Since we are developing with a self signed certificate, this will
 * remove the exceptions thrown by the Apache Http Client.
 * 
 */
// Inspired from here:
